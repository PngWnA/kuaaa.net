...
curl -X POST -H "Content-Type: application/json" -d '{"id": "djawnstlr", "pw": "djawnstlr", "name": "엄준식", "belong": "엄준식대학/엄준식학부", "email":"test@test.kr"}' localhost:31413/account/register
